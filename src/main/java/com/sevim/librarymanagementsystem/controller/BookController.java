package com.sevim.librarymanagementsystem.controller;
...
import com.sevim.librarymanagementsystem.service.CategoryService;
import com.sevim.librarymanagementsystem.service.PublisherService;
...
public class BookController {
	...
	@RequestMapping("/searchТwoCriteria")
	public String searchTwoCriteria(@Param("categoryId") Long categoryId,
									@Param("authorId") Long authorId,
									Model model) {

		final List<Book> result = bookService.filterByCategoryAndAuthor(categoryId,authorId);
